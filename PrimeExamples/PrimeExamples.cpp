...
int main(int argc, char*argv[])
{
	...
	//size_t maxValueToSearch = 10000000000;
	...
	size_t count2 =prime2.CountPrimes(0, 10000000000);
	std::cout << "Found " << count2 << " prime numbers between 0 and " << 10000000000 << std::endl;
